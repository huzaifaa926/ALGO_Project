from .ClusteringCoefficient import clustering_coefficient

def clustering_coefficient_helper(graph_nodes):
    # Formatting data for clustering coefficient algorithm
    graph = []
    ...
    return clustering_coefficient(vertices, graph,  graph_nodes[-1].get_node_name())